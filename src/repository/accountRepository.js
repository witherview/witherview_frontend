...
export const getUserStatisticsApi = async (param) => await api({
  url: '/api/myinfo',
  type: 'get',
  param,
});
...
export const getParticipateRoomsApi = async (param) => await api({
...
export const registerApi = async (param) => await api({
  url: '/register',
  type: 'post',
  param,
});
