...
export const ProfileMenuDefault = ({ src = profileImage }) => <ProfileMenuContainer src={src} />;
export const ProfileMenuName = ({ src = profileImage, name = '아무개' }) => <ProfileMenuContainer name={name} src={src} />;
